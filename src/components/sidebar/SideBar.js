            ...
            <div className={"col-md-2 col-xs-12 sidebar bg-white hide"} id="sidebar-wrapper">
                ...
                <div className="sidebar-sticky">
                    <ul className="nav flex-column">
                        ...
                        <li name="editProfile" className={this.props.active === 'editProfile' ? "nav-item active" :"nav-item"} onClick={this.activeLink}><Link className="nav-link"  name="editProfile" to="/editProfile"><i className="fa fa-user"/><span> Edit Profile </span></Link></li>
                        <li name="changePassword" className={this.props.active === 'changePassword' ? "nav-item active" :"nav-item"} onClick={this.activeLink}><Link className="nav-link"  name="changePassword" to="/changePassword"><i className="fa fa-lock"/> <span> Change Password </span></Link></li>
                        ...
                        <li name="contactSupportTeam" className={this.props.active === 'contactSupportTeam' ? "nav-item active" :"nav-item"} onClick={this.activeLink}><Link className="nav-link"  name="contactSupportTeam" to="/contactSupportTeam"><i className="fa fa-headphones"/><span> Contact Support Team </span></Link></li>
                    </ul>
                </div>
            </div>
        )
