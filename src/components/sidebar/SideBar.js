            ...
            <div className={"col-md-2 col-xs-12 sidebar bg-white hide"} id="sidebar-wrapper">
                ...
                <div className="sidebar-sticky">
                    <ul className="nav flex-column">
                        ...
                        <li name="hangePassword" className={this.props.active === 'changePassword' ? "nav-item active" :"nav-item"} onClick={this.activeLink}><Link className="nav-link"  name="changePassword" to="/changePassword"><i className="fa fa-lock"/> <span> Change Password </span></Link></li>
