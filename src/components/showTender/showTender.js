...
import { addFavoriteTender, deleteFavoriteTender } from '../../actionMethods/tenderActionMethods';
...
const mapDispatchToProps = dispatch => bindActionCreators({ addFavoriteTender, deleteFavoriteTender }, dispatch);
